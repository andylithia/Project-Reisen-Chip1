...
C {devices/ipin.sym} -320 10 0 0 {name=p3 lab=vp}
C {devices/ipin.sym} -320 50 0 0 {name=p4 lab=vn}
C {devices/ipin.sym} -320 90 0 0 {name=p6 lab=vbias}
C {devices/lab_wire.sym} -260 90 0 0 {name=l5 sig_type=std_logic lab=vbias}
C {devices/iopin.sym} -320 120 0 1 {name=p2 lab=vss}
C {devices/lab_wire.sym} -270 10 0 0 {name=l3 sig_type=std_logic lab=vp}
C {devices/lab_wire.sym} -280 50 0 1 {name=l7 sig_type=std_logic lab=vn}
C {devices/lab_wire.sym} -260 -20 0 1 {name=l10 sig_type=std_logic lab=vdd}
C {devices/iopin.sym} -320 -20 0 1 {name=p7 lab=vdd}
C {devices/lab_wire.sym} -270 120 0 0 {name=l11 sig_type=std_logic lab=vss}
...
C {devices/lab_wire.sym} -140 240 0 0 {name=l9 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 200 120 0 0 {name=l18 sig_type=std_logic lab=vss}
