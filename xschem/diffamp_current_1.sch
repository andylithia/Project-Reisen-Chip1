...
Power: 0.72mW} 510 -550 0 0 0.4 0.4 {}
N 230 -10 230 10 {
lab=GND}
N 230 10 630 10 {
lab=GND}
...
C {devices/vsource.sym} 880 -220 0 0 {name=V2 value=0.41}
C {devices/gnd.sym} 70 40 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} 960 -90 0 0 {name=V3 value=1.8}
C {devices/vsource.sym} 560 -160 0 0 {name=V4 value="AC -0.5"}
C {devices/vsource.sym} 300 -160 0 0 {name=V5 value="AC 0.5"}
