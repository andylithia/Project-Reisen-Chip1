...
S {}
E {}
T {<--- 0.3} 730 -170 0 0 0.4 0.4 {}
T {<--- 0.6} 730 -290 0 0 0.4 0.4 {}
T {<--- 0.9} 780 -230 0 0 0.4 0.4 {}
N 560 -190 560 -160 {
lab=vmid}
N 560 -160 710 -160 {
lab=vmid}
...
C {devices/isource.sym} 190 -220 0 0 {name=I1 value=15u}
...
C {devices/lab_wire.sym} 560 -270 0 0 {name=p3 sig_type=std_logic lab=vd1}
C {devices/lab_wire.sym} 710 -270 0 0 {name=p4 sig_type=std_logic lab=vd2}
C {devices/vsource.sym} 270 300 0 0 {name=V2 value=0.9}
C {devices/gnd.sym} 270 350 0 0 {name=l2 lab=GND}
C {devices/lab_wire.sym} 520 -220 0 0 {name=p5 sig_type=std_logic lab=vgp}
C {devices/lab_wire.sym} 750 -220 0 1 {name=p6 sig_type=std_logic lab=vgn}
C {devices/lab_wire.sym} 230 190 0 0 {name=p7 sig_type=std_logic lab=vgp}
C {devices/vsource.sym} 230 220 0 0 {name=V3 value="AC 0.5"}
C {devices/vsource.sym} 320 220 0 0 {name=V4 value="AC -0.5"}
...
C {sky130_fd_pr/pfet_01v8.sym} 540 -370 0 0 {name=M3
L=0.3
W=20
nf=1
mult=2
...
C {sky130_fd_pr/pfet_01v8.sym} 730 -370 0 1 {name=M5
L=0.3
W=20
nf=1
mult=2
...
C {sky130_fd_pr/pfet_01v8.sym} 810 -370 0 0 {name=M7
L=0.3
W=20
nf=1
mult=4
...
C {sky130_fd_pr/pfet_01v8.sym} 460 -370 0 1 {name=M8
L=0.3
W=20
nf=1
mult=4
...
C {devices/lab_wire.sym} 500 -410 0 0 {name=p10 sig_type=std_logic lab=vdd}
C {sky130_fd_pr/nfet_01v8.sym} 460 30 0 1 {name=M9
L=0.3
W=20
nf=1 
mult=2
...
C {sky130_fd_pr/nfet_01v8.sym} 810 30 0 0 {name=M10
L=0.3
W=20
nf=1 
mult=2
...
C {devices/lab_wire.sym} 500 -100 0 0 {name=p11 sig_type=std_logic lab=vbias}
C {devices/gnd.sym} 640 110 0 0 {name=l4 lab=GND}
C {devices/lab_wire.sym} 870 -160 0 0 {name=p12 sig_type=std_logic lab=vout}
C {sky130_fd_pr/pfet_01v8.sym} 690 -490 0 0 {name=M11
L=0.3
W=10
nf=1
mult=4
...
C {sky130_fd_pr/pfet_01v8.sym} 580 -490 0 1 {name=M12
L=0.3
W=10
nf=1
mult=4
